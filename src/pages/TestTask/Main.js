...
const Main = () => (
  <main>
    <div className="main">
      ...
      <p className="main__project-description">
        Register and participate in the volunteer support program for stray animals
        <br />
        {' '}
        at our shelter this weekend with your family or team
      </p>
